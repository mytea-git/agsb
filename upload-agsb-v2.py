...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "mainking"         # 用户名
UUID = "b2fed810-80a4-4e7a-9f1e-0fb19459d8db"                     # UUID，留空则自动生成
PORT = 10699                   # Vmess端口，留空或0则自动生成
DOMAIN = "https://voo.birthdaycc.dpdns.org/"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiOWE2ZWJiNTQzODFkMWMyMDIzM2NkNWM0OGE4NjMyOWUiLCJ0IjoiY2Y4NGU1MTItYmI2Yi00NmU4LWJiMmYtODdlMjYxMmJjNTk1IiwicyI6Ik9EWmtZek0xTldJdE5URTNPUzAwTlRZeUxUbGpOekF0WXpFNU9XTmlZamhqT1RjeCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
